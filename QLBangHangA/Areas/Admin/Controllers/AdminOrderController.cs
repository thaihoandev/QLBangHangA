    ...
    public class AdminOrderController : Controller
    {
        ...
        public IActionResult Index(int? page = 0)
        {
            ...
            var lsOrders = _context.Orders
                .AsNoTracking()
                .OrderByDescending(x => x.OrderId).Where(y => y.TransactStatusId == confirmed.TransactStatusId); ;
        ...
        public IActionResult Pending(int? page = 0)
        {
            ...
            var lsOrders = _context.Orders
                .AsNoTracking()
                .OrderByDescending(x => x.OrderId).Where(y => y.TransactStatusId == pending.TransactStatusId); ;
            PagedList<Order> models = new PagedList<Order>(lsOrders, pageNumber, pageSize);
            ViewBag.CurrentPage = pageNumber;
